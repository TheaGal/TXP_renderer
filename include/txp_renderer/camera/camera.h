...
public:
    ...
    void set_follow_orbit_cam_offset_pos(vec3 const offset_position);  // @THHEA: this needs to be made back into a float.
    ...
    void set_follow_orbit_cam_angle_offset_euler(vec3 const offset_angles);
