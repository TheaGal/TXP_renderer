...
private:
    ...
    animator_frame_t& get_profile_frame_handle(Animator_timer_profile profile) const;

    animator_frame_t m_sim_frame{ (uint32_t)-1 };  // -1 for showing timer is unset on first update().
